...
public class SendMail {
    ...
    public static void ComposeGmail(String toMail, String groupReport) {
        ...
        try {
            ...
            message.setFrom(new InternetAddress("oliprosper.auto@gmail.com"));
            ...
            messageBodyPart.setText("Hello," + "\n" +"Attached to this mail is the report of an automated test.");
            ...
            Transport.send(message, "oliprosper.auto@gmail.com", "@Password1!!");
